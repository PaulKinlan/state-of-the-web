...
<section aria-labelledby="site-results"><h2 id="site-results">Sites that passed and failed</h2><div class="controls"><label>Search sites<input id="search" type="search" placeholder="example.com"></label><label>Filter status<select id="status-filter"><option value="">All statuses</option><option value="issues">Issues</option><option value="pass">Pass</option><option value="not-applicable">Not assessed / N/A</option></select></label><label>Order<select id="order"><option value="failures">Failures first</option><option value="successes">Passes first</option><option value="rank">Source position</option><option value="score">Overall score</option><option value="confidence">Confidence</option><option value="site">Site name</option></select></label></div>
